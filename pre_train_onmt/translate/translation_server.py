...
from pre_train_onmt.utils.logging import init_logger
from pre_train_onmt.utils.misc import set_random_seed
from pre_train_onmt.utils.misc import check_model_config
from pre_train_onmt.utils.alignment import to_word_align
from pre_train_onmt.utils.parse import ArgumentParser
from pre_train_onmt.translate.translator import build_translator
from pre_train_onmt.transforms.features import InferFeatsTransform
...
class ServerModel(object):
    ...
    def parse_opt(self, opt):
       ...
       Returns:
        ...
        pre_train_onmt.opts.translate_opts(parser)
