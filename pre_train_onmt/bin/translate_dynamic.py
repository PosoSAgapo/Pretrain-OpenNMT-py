...
from pre_train_onmt.inputters.text_dataset import InferenceDataReader
from pre_train_onmt.transforms import get_transforms_cls, make_transforms, TransformPipe

import pre_train_onmt.opts as opts
