...
from pre_train_onmt.model_builder import build_embeddings, \
    build_encoder, build_decoder
from pre_train_onmt.utils.parse import ArgumentParser

parser = ArgumentParser(description='train.py')
pre_train_onmt.opts.model_opts(parser)
pre_train_onmt.opts._add_train_general_opts(parser)
...
class TestModel(unittest.TestCase):
    ...
    def get_field(self):
        src = pre_train_onmt.inputters.get_fields("text", 0, 0)["src"]
    ...
    def nmtmodel_forward(self, opt, source_l=3, bsize=1):
        ...
        model = pre_train_onmt.models.model.NMTModel(enc, dec)
...
if pre_train_onmt.models.sru.check_sru_requirement():
